(function () {
  ...
  async function openKlevbyPublicProfile(userId, fallbackData = {}) {
    ...
    if (typeof render.renderLoading === "function") render.renderLoading();
    ...
    try {
      ...
      if (typeof render.renderProfile === "function") {
        render.renderProfile(profile || {}, Array.isArray(photos) ? photos : []);
      }
    } catch (error) {
      ...
      if (typeof render.renderError === "function") {
