(function () {
  ...
  function collectSplashDiagnostics() {
    ...
    if (!raw) {
      return {
        startedAt: null,
        initialStateAppliedAt: null,
        animationClassAddedAt: null,
    ...
    return {
      ...
      animationClassAddedAt: raw.animationClassAddedAt ?? null,
      animationStartedAt: raw.animationStartedAt ?? null,
      animationCompletedAt: raw.animationCompletedAt ?? null,
